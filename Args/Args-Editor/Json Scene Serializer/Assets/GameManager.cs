...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(finalOut);
        System.IO.File.WriteAllText(@"C:\Users\blazi\Documents\Fork\Project-startup\Args\Args-Editor\Json Scene Serializer\Assets\" + SceneManager.GetActiveScene().name + ".JSON","{Scene:"+finalOut+"}");
    }
