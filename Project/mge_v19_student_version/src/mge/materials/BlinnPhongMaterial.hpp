 ...
 */
class BlinnPhongMaterial : public Material<BlinnPhongMaterial>
{
public:
	BlinnPhongMaterial(std::string name = "PBR Material",
		...
		Texture* pHeight = nullptr, float pHeightScale = 0.05f);
...
private:
	...
	BlinnPhongMaterial(const BlinnPhongMaterial&);
	BlinnPhongMaterial& operator=(const BlinnPhongMaterial&);
};